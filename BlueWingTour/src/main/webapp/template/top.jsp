...
<div class="content-section"><!-- class="content-section" 시작-->
			<div id="center"><!-- 시작 id="center" -->
				<h1 class="logo"><a href="/BlueWingTour/main/index.do"><img src="../image/logo.png"></a></h1>
			...
			<div class="all_menu"><button type="button" class="all_menu_btn"><i class="bar"></i>
						...
						<img src="../image/usa.png" style="margin-left:180px;width:25px;"><span class="fir_span"><a href="">미국</a></span>
						<img src="../image/jpa.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">일본</a></span>
						<img src="../image/spa.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">스페인</a></span>
						<img src="../image/lta.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">이탈리아</a></span>
						<img src="../image/mal.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">말레이시아</a></span>
						<img src="../image/bea.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">베트남</a></span>
						<img src="../image/tae.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">태국</a></span>
						<img src="../image/ge.png" style="width:25px;margin-left:30px;"><span class="sp"><a href="">그리스</a></span>
			</div>
			<div id="container_map" class="main" style="display: none;">
				<div class="top_menu">
					<div class="menuList1">
						<h2 style="border-bottom:1px solid #c8c8c8">패키지 여행</h2>
						<ul class="menuList1_ul">
							<li style="margin-left:-45px;"><h4><a href="">미국</a></h4></li>
							<li style="margin-left:-40px;"><h6><a href="">하와이</a></h6></li>
							<li style="margin-left:-30px;"><h6><a href="">플로리다</a></h6></li>
							...
							<li style="margin-left:-30px;margin-top:10px;"><h4><a href="">스페인</a></h4></li>
							<li style="margin-left:-30px;"><h6><a href="">발렌시아</a></h6></li>
							<li style="margin-left:-15px;margin-top:10px;"><h4><a href="">이탈리아</a></h4></li>
							<li style="margin-left:-30px;"><h6><a href="">베네치아</a></h6></li>
						</ul>
						<ul class="menuList1_ul">
							...
							<li style="margin-left:-7px;"><h6><a href="">다낭</a></h6>
							<li style="margin-left:3px;"><h6><a href="">호이안</a></h6>
							<li style="margin-left:12px;margin-top:10px;"><h4><a href="">그리스</a></h4></li>
							<li style="margin-left:10px;"><h6><a href="">산토리니</a></h6>
							<li style="margin-left:42px;margin-top:10px;"><h4><a href="">말레이시아</a></h4></li>
